...
const test = require('./testers/resolveOne/test');
const testError = require('./testers/resolveOne/testError');
const inputFixture = require('./fixtures/inputFixture.json');
const testObject = require('./fixtures/resolve/testObject.json');

const { getOne } = require('../index');
...
describe('Test get function', () => {
  ...
  it('Attempt to get "$end" from object returns value', () => {
    ...
    expect(getOne(testObject, 'stores["$end"].storeName')).toStrictEqual('Amsterdam');
  });
